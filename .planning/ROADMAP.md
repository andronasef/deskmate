...
Plans:
- [ ] 01-01: Vite 8 + React 19 + TypeScript 6.0.3 scaffold (override default TS 7), lint/type toolchain, static app shell that boots and renders a default dashboard shell
